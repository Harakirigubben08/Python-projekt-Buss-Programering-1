...
Catchphrase =["Rör mig igen kommer jag att klubba ner dig!",
    "Det där var min lever, tack för påminnelsen om att jag behöver donera den snart.",
    "Petar du igen lär det bli det sista du gör.",
    "Åh nej, nu väckte du parasiterna... de blir hungriga när man tar på mig.",
    "Grattis, du vann precis galet mycket pengar, skriv in dina bankuppgifter bara.",
    "Sluta! Jag är inte en knapp, jag är en mänsklig landmina!",
